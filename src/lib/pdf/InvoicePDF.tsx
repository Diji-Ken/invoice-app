...
export function InvoicePDF({ invoice, customer, settings }: InvoicePDFProps) {
          ...
          <View style={s.rightCol}>
            <View style={s.issuerInfo}>
              ...
              {settings.address_line1 ? (
                <Text style={s.issuerDetail}>{settings.address_line1}</Text>
              ) : null}
              {settings.address_line2 ? (
                <Text style={s.issuerDetail}>{settings.address_line2}</Text>
              ) : null}
              {settings.phone ? (
        ...
        <View style={s.summaryBlock}>
          <View style={s.summaryTable}>
            ...
            <View style={s.summaryRow}>
              ...
              <Text style={s.summaryValue}>{fmtCurrency(invoice.tax)}</Text>
            </View>
